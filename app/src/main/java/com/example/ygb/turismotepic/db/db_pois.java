...
public class db_pois extends SQLiteOpenHelper {
    ...
    //--------------------------------Insert Table Query
    public static final String SQL_INSERT_ENTRIES = "INSERT INTO `pois` (`id_poi`, `id_categoria`, `nombre`,`latitud`, `longitud`) " +
            "VALUES " +
            "(1,3,'Catedral ','21.5105914','-104.8906753')," +
            ...
            "(41,10,'Sanitarios','21.51254','-104.893064')";
